export const projectsData = [
  {
    id: "advertising-projects",
    slug: "advertising-projects",
    sector: "Advertising",
    ...
    projects: [
      {
        ...
        name: "HITEC City Highway DOOH Billboard",
      ...
      {
        id: "metro-junction-screen",
        name: "Prime Urban Transit Digital Facade",
      ...
      {
        id: "lifestyle-retail-display",
        name: "Luxury Mall Entrance Showcase",
    ...
    projects: [
      {
        ...
        name: "Central University Mega Auditorium Screen",
      ...
      {
        id: "tech-campus-atrium",
        name: "Engineering Institute Innovation Atrium",
        location: "Hyderabad, Telangana",
  ...
  },
  {
    ...
    projects: [
      {
        id: "smart-city-noc",
        name: "Municipal Integrated Command & Control Center",
      ...
      {
        id: "assembly-hall-screen",
        name: "State Secretariat Conference Suite",
    ...
    projects: [
      {
        ...
        name: "Spiritual Sansthan Devotee Viewing Screens",
      ...
      {
        id: "pilgrim-courtyard-outdoor",
        name: "Pilgrimage Center Outdoor Plaza Screen",
  ...
  {
    id: "rental-events-projects",
    slug: "rental-events-projects",
    sector: "Rental & Events",
    ...
    projects: [
      {
        ...
        name: "Arena Stadium Music Festival Main Stage",
      ...
      {
        id: "auto-expo-launch",
        name: "National Auto Expo Vehicle Reveal Stage",
    ...
    projects: [
      {
        ...
        name: "International Cricket Stadium Perimeter Line",
        location: "India",
      ...
      {
        id: "indoor-arena-scoreboard",
        name: "National Sports Complex Center-Hung Cube",
        location: "New Delhi",
